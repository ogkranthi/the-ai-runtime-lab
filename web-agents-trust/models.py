"""Shared data model for Field Lab 01 module 2, the reliability layer.

Module 1 hands over a prospect list. Module 2 reads it as Claims and judges them:

- A `Claim` is one field's value about a company, plus every source for it.
